...
class FasterRCNNModel:
    ...
    def create_model(self):
        try:
            ...
            logger.error(f"Fail to create model{e}")
            raise CustomException("Fail to create model ", e)
    ...
    def compile(self, lr = 1e-4):
        try:
            ...
            logger.eror(f"Fail to compile model {e}")
            raise CustomException("Fail to compile model ",e)
